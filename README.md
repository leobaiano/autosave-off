...
Plugin WordPress for disables the function automatically save posts WordPress

## Contribute ##

You can contribute to the source code in our [GitHub](https://github.com/leobaiano/autosave-off) page.
...
2. Check [issues](https://github.com/leobaiano/autosave-off/issues) and choose one that does not have anyone working;
...
**Note:** If you want to contribute to something that was not recorded in the [issues](https://github.com/leobaiano/autosave-off/issues) it is important to create and subscribe to prevent someone else to start working on the same thing you.
